;(function() {
  var photoPosts = [
    {
      id: '1',
      description: 'здание в Варшаве, являющееся самым высоким зданием в Польше. ' +
      'Расположено в центре города на площади Парадов, 1. В наши дни дворец входит в десятку высочайших небоскрёбов Европейского Союза ' +
      'Построено по образцу так называемых «сталинских высоток» в качестве подарка Советского Союза польскому народу ',
  ...
  function sortByDate(array) {
    ...
    return findPosts.sort(function(a,b){return a.createdAt - b.createdAt});
  }
